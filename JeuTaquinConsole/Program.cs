...
namespace JeuTaquinConsole
{
    ...
    class Program
    {
        ...
        /// <summary>
        /// Auteur:          Claudel D. Roy & Mathieu Duval
        /// Description :    Appel de la classe JeuTaquinLogique.
        /// Date:            2022-03-09
        /// </summary>
        static JeuTaquinLogique _jeu = new JeuTaquinLogique();
        #endregion
        ...
        /// <summary>
        /// Auteur:         Claudel D. Roy & Mathieu Duval
        /// Description:    Programme qui permet le déroulement d'une partie de Jeu de Taquin sur console.
        /// Date:           2022-02-23
        /// </summary>
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (Touche.Key == ConsoleKey.UpArrow)
                        _jeu.DeplacerVers(JeuTaquinLogique.Directions.HAUT);
                    else if (Touche.Key == ConsoleKey.DownArrow)
                        _jeu.DeplacerVers(JeuTaquinLogique.Directions.BAS);
                    else if (Touche.Key == ConsoleKey.LeftArrow)
                        _jeu.DeplacerVers(JeuTaquinLogique.Directions.GAUCHE);
                    else if (Touche.Key == ConsoleKey.RightArrow)
                        _jeu.DeplacerVers(JeuTaquinLogique.Directions.DROITE);
